...
window.CYBER_TRANSLATIONS = {
  tr: {
    ...
    nav_kadikoy: "Kadıköy & Ataşehir Ağı",
    nav_matrix: "SEO DoFollow Link Kasası",
    settings_title: "PBN Kontrol Paneli Ayarları",
    setting_lang: "Varsayılan Dil",
    setting_lang_desc: "PBN Arayüz ve İçerik Dili",
    setting_theme: "PBN Renk Teması",
    setting_theme_desc: "Siber & Lüks PBN Paleti",
    save_settings: "Ayarları Kaydet ve Uygula",
    toast_copy: "Hedef URL panoya kopyalandı!",
  ...
  en: {
    ...
    nav_kadikoy: "Kadikoy & Atasehir Network",
    nav_matrix: "SEO DoFollow Link Vault",
    settings_title: "PBN Control Panel Settings",
    setting_lang: "Default Language",
    setting_lang_desc: "PBN UI and Content Language",
    setting_theme: "PBN Color Theme",
    setting_theme_desc: "Cyber & Luxury PBN Palette",
    save_settings: "Save & Apply Settings",
    toast_copy: "Target URL copied to clipboard!",
    toast_settings: "PBN Settings applied!"
  }
};
